...
rem    -Dserver.ssl.key=<path>  设置http ssl 证书私钥文件路径
rem    -Dserver.ssl.cert=<path> 设置http ssl 证书文件路径（PEM格式）
rem -----------------------------------------------------------
...
rem    --server-ssl-key=<path>  设置http ssl 证书私钥文件路径
rem                             例如：--server-ssl-key=C:\Users\ASUS\Downloads\private.key
rem    --server-ssl-cert=<path> 设置http ssl 证书文件路径（PEM格式）
